...
- `public/social-image.jpg` is a 1200 × 630 portrait card (40,423 bytes). Social image URLs follow the existing deployment-origin policy; canonical page URLs use `site.origin`.
